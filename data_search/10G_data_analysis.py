...
import json
print('开始读数据...')
input_folder = '/home/xh/data_search/cleaned_parts/*/*.parquet'
...
plt.tight_layout()
plt.savefig('/home/xh/data_search/income_vs_purchase_price.png')  # 保存图片
...
plt.tight_layout()
plt.savefig('/home/xh/data_search/high_value_users_age_distribution.png')  # 保存图片
...
plt.ylabel('value')
plt.tight_layout()
plt.savefig('/home/xh/data_search/income_distribution.png')  # 保存图片
...
plt.ylabel('value')
plt.tight_layout()
plt.savefig('/home/xh/data_search/credit_distribution.png')  # 保存图片
...
plt.ylabel('value')
plt.tight_layout()
plt.savefig('/home/xh/data_search/purchase_price_distribution.png')  # 保存图片
print("可视化图像已保存到指定目录。")
